...
const Card2 = async (props) => {
    ...
    const cardStyle=`${props.page!=='dias' ? 'h-fit' : `${props.page}_card2`} text-xl bg-white/50 shadow-md p-4 rounded-lg text-sm p-4 gap-4`
    ...
    const flexStyle= `${props.page!=='dias' ? 'flex-col' : 'flex items-center'} body gap-3`
            ...
            <div className={flexStyle}>
                ...
                return(
                    <div className='flex gap-1 items-center'>
                      <div>{icono ? icono.icono : null }</div>  
                      { existeClave ?
